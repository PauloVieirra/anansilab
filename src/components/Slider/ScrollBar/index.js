...
function Item(props) {
  return (
    <div style={{ background: props.color, width: '50%', height: '200px' }}>
      <h2>{props.title}</h2>
    </div>
  );
}
...
const items= [
  {id:1,
    ...
    sobrenome:'',
    funcao:'Raper',
    descricao:'Grupo de Rap/rock com letras que falam sobre empoderamento e amor próprio, ganhou prêmios de melhor intérprete em festivais de música universitária em 2019 e 2020.',
    ...
    discos:{
      albumu:{
        ...
        tipo:'LP',
        ano:'2020',
        url:'https://i.pinimg.com/564x/a2/04/fd/a204fd8368195e6f3f70f73d4f711980.jpg',
         
        urlimgmp1:'https://i.pinimg.com/236x/a4/56/c3/a456c3ee8c5bf3cc6d771523e07ec107.jpg',
        musica1:'Go Beck go',
      ...
      albumd:{
        ...
        ano:'2022',
        tipo:'LP',
        url:'https://i.pinimg.com/564x/dc/21/ef/dc21effcd4233ef784c9a51a1a65e6dc.jpg',

        urlimgmp1:'https://i.pinimg.com/236x/f0/8a/6d/f08a6da0773b07770390c1dc17a97b27.jpg',
        musica1:'So Bad, came-Bad',
        faixa1:'../Songs/Artits8/audio1.mp3',

        urlimgmp2:'https://i.pinimg.com/736x/0e/9d/46/0e9d467279bd20098fddc5f0cb5455af.jpg',
        musica2:'AnAnimals',
      ...
      albumt:{
        ...
        ano:'2022',
        tipo:'LP',
        url:'https://i.pinimg.com/236x/12/e6/35/12e635ef69444e708a22f999ef4e29a2.jpg',

        urlimgmp1:'https://i.pinimg.com/564x/8b/b0/d8/8bb0d80bef739766e72dd64c3e1b1251.jpg',
        musica1:'Save-me',
        faixa3:'../Songs/Artits8/audio4.mp3',

        urlimgmp2:'https://i.pinimg.com/564x/91/b3/75/91b3759cbea35165bf7537dc9efdcb25.jpg',
        musica2:'My flower was you',
...
export default function ScrollBar() {
  ...
  const itensRenderizados = items.map((item) => {
